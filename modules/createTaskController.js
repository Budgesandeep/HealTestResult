...
createTask_cntrl_offline.updateTaskOffline = function(selectedTask){ 
  ...
  var compPrimaryKey = {facilityId:userInfo.selectedFacilityId, taskUuid:selectedTask[0].taskId,userID:userInfo.userName};
...
createTask_cntrl_offline.getCreatedTasksList = function(){  
  ...
  var wcs = 
      "where userIdValue =" + JSON.stringify(userInfo.userName) + 
