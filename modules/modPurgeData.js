...
mod_purge_data.purge30DaysOldDataEveryDay = function(patientList,objToDelete){ 
  ...
  if(objToDelete === com.healogic.offline.patientList ||  
     objToDelete === com.healogic.offline.patientInfo || 
    objToDelete === com.healogics.offline.patientWounds2 ||
    objToDelete === com.healogics.offline.getPatientRecords)
  {
    ...
    objToDelete.removeDeviceInstance (wcs, successCallBack,
     errorCallBack);
...
//And not any future date appointment
      ...
      var wcs = 
        "where nextAppointment <" + JSON.stringify(prior30DaysDate) ;
