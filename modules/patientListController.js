...
patientList_cntrl_offline.getAllPatientListForFacilityID = function(facilityID,userID){
  ...
  if(patientListConstants.myPatients=="Y"){
    wcs = "where physicianUserId = "+ JSON.stringify(userID) +
      " or caseManagerUserId = " + JSON.stringify(userID) +" and facilityId = "+ JSON.stringify(facilityID) +" ORDER BY name";
  }else{
...
patientList_cntrl_offline.getAllPatientListForMsrWeek = function(week){
  ...
  if(week===null||week===""||week===undefined){
    if(patientListConstants.myPatients=="Y"){
      wcs = "where (physicianUserId = "+ JSON.stringify(userInfo.userId) +
        " or caseManagerUserId = " + JSON.stringify(userInfo.userId) +") and facilityId = "+ JSON.stringify(userInfo.selectedFacilityId)+" ORDER BY name";
    }else{
    ...
    if(patientListConstants.myPatients=="Y"){
      wcs = "where (physicianUserId = "+ JSON.stringify(userInfo.userId) +
        " or caseManagerUserId = " + JSON.stringify(userInfo.userId) +") and facilityId = "+ JSON.stringify(userInfo.selectedFacilityId)+" and msrFlag = 'true'"+" ORDER BY name";
    }else{
