...
function onscopesuccessCallback(outputparams){
  ...
  if(isIndividualScopeSync === false){	  
   ...
   if(kony.store.getItem(keyCurrentSyncTime) !== null){
    ...
    if((isIndividualScopeSync === true ) &&
      ((whichScope == outputparams.currentScope) || (outputparams.currentScope == SYNC_CONSTANTS.scopeGetPatientRecords)))
	{
...
function modSyncScopes_offline_initialAndDeltaScopes(){
  ...
  if(isIpad){
    initialDownloadScopes = {
      "AuthorizedAccess":{doupload:true, dodownload:true, uploaderrorpolicy:"continueonerror"},
      "Patients":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"},
      "appList":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"},
      "metrics":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"},
      "login":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},///would be false
      "scopeWoundHealingSteps":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"},
      "woundSummary2":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"},///new Scope by Muzib created
      "healingStepsConf":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},
      "userMetrics":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"},
      "taskAndNotes":{doupload:true, dodownload:true, uploaderrorpolicy:"continueonerror"},
      "healingSteps":{doupload:true, dodownload:true,uploaderrorpolicy:"continueonerror"},
      "OfflinePhotoUpload":{doupload:true, dodownload:false,uploaderrorpolicy:"continueonerror"},
      "OfflinePatientRecords":{doupload:true, dodownload:true,uploaderrorpolicy:"continueonerror"}
    };
  }else{
    initialDownloadScopes = {
      "AuthorizedAccess":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},
      "Patients":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"},
      "appList":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"},
      "metrics":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},
      "login":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},///would be false
      "scopeWoundHealingSteps":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},
      "woundSummary2":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},///new Scope by Muzib created
      "healingStepsConf":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},
      "userMetrics":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},
      "taskAndNotes":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},
      "healingSteps":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
      "OfflinePhotoUpload":{doupload:true, dodownload:false,uploaderrorpolicy:"continueonerror"},
      "OfflinePatientRecords":{doupload:true, dodownload:true,uploaderrorpolicy:"continueonerror"}
    };
  }
...
//   modSyncDelta_offline_createUniqueSyncSession(nineStepsDownloadScopes);
  ...
  sessionScopes = {
                        "AuthorizedAccess":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
                        "Patients":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
                        "appList":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
                        "metrics":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
                        "login":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
                        "scopeWoundHealingSteps":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"},
                        "woundSummary2":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},///new Scope by Muzib created
                        "healingStepsConf":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
                        "userMetrics":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
                        "taskAndNotes":{doupload:false, dodownload:false, uploaderrorpolicy:"continueonerror"},
    					"healingSteps":{doupload:true, dodownload:true,uploaderrorpolicy:"continueonerror"},
        				"OfflinePhotoUpload":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
  						"OfflinePatientRecords":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"}
...
function modSyncScopes_offline_photoUpload(){
  ...
  sessionScopes = {
    					...
    					"healingSteps":{doupload:false, dodownload:false,uploaderrorpolicy:"continueonerror"},
    					"OfflinePhotoUpload":{doupload:true, dodownload:false,uploaderrorpolicy:"continueonerror"},
  						"OfflinePatientRecords":{doupload:false, dodownload:true,uploaderrorpolicy:"continueonerror"}
                      };  
  isIndividualScopeSync = true;
...
function modSyncScopes_offline_onlyLogin(){
  var loginDownloadScopes = {
						   			"login":{doupload:false, dodownload:true, uploaderrorpolicy:"continueonerror"}
						    	};
