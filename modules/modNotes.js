...
notesModule.createNotes=function(){
  ...
  com.healogics.mfutility.invokeIntegrationService(
    ...
    inputData,
    notesModule.createNotesSuccessCallback,
    notesModule.NotesModuleFailureCallback
  );
...
notesModule.getNotes=function(){
  ...
  com.healogics.mfutility.invokeIntegrationService(
    MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL,
    MF_SERVICECONSTANTS.OPERATION_NAME_GETNOTELIST,
    {
      "Content-Type":"application/json",
      "Authorization" : userInfo.headerAccessToken,
      "patientId" : notes_info.patientId,
    ...
    inputData,
    notesModule.getNotesSuccessCallback,
    notesModule.getNotesModuleFailureCallback
  );
};
