...
facilitySearchByModule.getSearchedById = function(){
  ...
  com.healogics.mfutility.invokeIntegrationService(
    ...
    MF_SERVICECONSTANTS.OPERATION_NAME_ADMINSEARCHBYID,
    {
    ...
    inputData,
    facilitySearchByModule.SearchBySuccessCallback,
    facilitySearchByModule.SearchByFailureCallback
  );
};
...
facilitySearchByModule.getSearchedByName = function(){
  ...
  com.healogics.mfutility.invokeIntegrationService(
    MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL,
    MF_SERVICECONSTANTS.OPERATION_NAME_ADMINSEARCHBYNAME,
    {
      "Content-Type":"application/json",
      "Authorization" : userInfo.headerAccessToken,
      "facilityId" : userInfo.presentFacilityId,
...
facilitySearchByModule.getSearchedByBid = function(){
  ...
  com.healogics.mfutility.invokeIntegrationService(
    MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL,
    MF_SERVICECONSTANTS.OPERATION_NAME_ADMINSEARCHBYBID,
    {
      "Content-Type":"application/json",
      "Authorization" : userInfo.headerAccessToken,
      "facilityId" : userInfo.presentFacilityId,
    ...
    for(var i in facilityList){
      ...
      if(facilityList[i]["facilityScreens"]!=null){
        ...
        if(tempRecord["btncheckbox1"] == "false" || tempRecord["btncheckbox1"] == false){
          ...
          tempRecord["btncheckbox1"] = {skin:"sknbtncheck",hoverSkin:"skbtntranshover"};
        }
        if(tempRecord["btncheckbox2"] == "false" || tempRecord["btncheckbox2"] == false){
          ...
          tempRecord["btncheckbox2"] = {skin:"sknbtncheck",hoverSkin:"skbtntranshover"};
        }
      }else{
...
facilityUpdateModule.getFacilityUpdated = function(){
  ...
  com.healogics.mfutility.invokeIntegrationService(
    MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL,
    MF_SERVICECONSTANTS.OPERATION_NAME_ADMINFACILITYUPDATE,
    {
      "Content-Type":"application/json",
      "Authorization" : userInfo.headerAccessToken,
      "facilityId" : userInfo.presentFacilityId,
    ...
    inputData,
    facilityUpdateModule.updateSuccessCallback,
    facilityUpdateModule.updateFailureCallback
  );
};
