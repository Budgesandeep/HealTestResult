...
dashboardModule.getUserAcknowledgementStatus = function(){
  ...
  com.healogics.mfutility.invokeIntegrationService(
    ...
    MF_SERVICECONSTANTS.OPERATION_NAME_GETUSERACKNOWLEDGEMENT,
    {
    ...
    inputData,
    dashboardModule.getUserAcknowledgementSuccessCallback,
    dashboardModule.userAcknowledgementFailureCallback
  );
};
...
dashboardModule.getUserAcknowledgementSuccessCallback = function(response){
  ...
  if(response!==null && response.opstatus === 0 && response.statuscode == "200"){
    ...
    if(userInfo.ackAcceptedDate!==null && userInfo.ackAcceptedDate!=="" && (todaysDate <= expiryDate)){
      ...
      if(!isIpad)
        frmLanding.fcmstfooter.top = "600dp";
...
dashboardModule.updateUserAcknowledgementStatus = function(){
  ...
  com.healogics.mfutility.invokeIntegrationService(
    MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL,
    MF_SERVICECONSTANTS.OPERATION_NAME_UPDATEACKNOWLEDGEMENT,
    {
      	"Content-Type":"application/json",
      	"Authorization" : userInfo.headerAccessToken,
      	"facilityId" : userInfo.presentFacilityId,
    ...
    inputData,
    dashboardModule.updateUserAcknowledgementSuccessCallback,
    dashboardModule.userAcknowledgementFailureCallback
  );
};
...
function onClick_Menu(option){
  ...
  else if(option == "switchfacility" || option == "reports"){
...
function frmEncounters_showForm(){
  ...
  frmEncounters.lblPatientName.text = patientSummaryObjects.patientDemoGraphics.firstName +
    " " + patientSummaryObjects.patientDemoGraphics.lastName; 
  frmEncounters.show();
...
var popupnotification_doNotShowButtonHandler = function (eventObj){
  ...
  if(eventObj.skin === "sknbtnuncheck"){
    selectedItem.btnDoNotShow = {"skin":"sknbtncheck"};
  }else{
    selectedItem.btnDoNotShow = {"skin":"sknbtnuncheck"};
  }
...
var popupnotification_getPushNotifications = function(){
  var inputData = {
    ...
    com.healogics.mfutility.invokeIntegrationService(
    MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL,
    MF_SERVICECONSTANTS.OPERATION_NAME_GETPUSHNOTIFICATION,
    {
      "Authorization" : userInfo.headerAccessToken,
      "Content-Type" : "application/json",
    ...
    inputData,
   popupnotification_getPushNotificationSuccessCallback,
   popupnotification_getPushNotificationFailureCallback,
    true
  ); 
};
var popupnotification_getPushNotificationSuccessCallback = function (response){
  ...
  if(response !== null && response !== "" && response.opstatus ===0 && response.statusCode === "200"){
    ...
    for (var item in response.Notification){
      ...
      var segmentObj = {"lblTitle":com.healogics.utility.isEmpty(notification.title) ? "":notification.title,
                        "lblDescription":notification.description,"btnDoNotShow": {"skin":"sknbtnuncheck"},"notificationID":notification.notificationID,
                       "lblDoNotShow":"Do not show this message again"};
      if(!com.healogics.utility.isEmpty(notification.hyperlink)){
        segmentObj.lnkWebsite = {"text":notification.hyperlink,"externalURL":notification.hyperlink}; 
...
var popupnotification_dismissNotification = function(selectedNotifications){
    var inputData = { "facilityID":userInfo.presentFacilityId,
      "userName":userInfo.userName,
      "userID": userInfo.userId,
    ...
    com.healogics.mfutility.invokeIntegrationService(
    MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL,
    MF_SERVICECONSTANTS.OPERATION_NAME_DISMISSNOTIFICATION,
    {
      "Authorization" : userInfo.headerAccessToken,
      "Content-Type" : "application/json",
      "Accept" : "application/json",
    ...
    inputData,
   popupnotification_dismissNotificationSuccessCallback,
   popupnotification_dismissNotificationFailureCallback,
    true
  ); 
};
