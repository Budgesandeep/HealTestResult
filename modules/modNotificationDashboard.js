...
var frmNotificationDashboard_preShow = function(){
 ...
 var frmNotificationDashboard_PostShow = function(){
   ...
   var inputData = {};
    ...
    MF_SERVICECONSTANTS.OPERATION_NAME_NOTIFICATIONLIST,
    {
    ...
    inputData,
   notificationModule.notificationListSuccessCallback,
   notificationModule.notificationListFailureCallback,
    true
  );
};
