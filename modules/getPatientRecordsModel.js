...
com.healogics.offline.getPatientRecords.create = function(valuestable, successcallback,errorcallback,markForUpload){
	...
	if(kony.sync.enableORMValidations){
		...
		pks["documentUUID"] = {key:"documentUUID",value:valuestable.documentUUID};
		errMsg = errMsg + ", patientId=" + valuestable.patientId;
		pks["patientId"] = {key:"patientId",value:valuestable.patientId};
...
com.healogics.offline.getPatientRecords.prototype.getPKTable = function(){
	...
	var pkTable = {};
	pkTable.documentUUID = {key:"documentUUID",value:this.documentUUID};
	pkTable.patientId = {key:"patientId",value:this.patientId};
	return pkTable;
};
