...
function iPadOnEnteringForeground() {
    ...
    try {
        if (idleTimeoutConstants.didTimerStartAfterIdleTimeout && idleTimeoutConstants.timeCompletedinPopup != null && idleTimeoutConstants.timeCompletedinPopup != "") {
            ...
            var remainingSeconds = parseInt(idleTimeoutConstants.timeCompletedinPopup.substring(0, 2)) * 60 + parseInt(idleTimeoutConstants.timeCompletedinPopup.substring(3, 5));
...
function setCallBacks() {
    ...
    var callbacksObj = {
        onactive: test,
        oninactive: test,
        onbackground: iPadOnEnteringBackground,
        onforeground: iPadOnEnteringForeground,
        onappterminate: test
    };
