...
metrics_module.load_MetricsData = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.ORCHESTRATION_SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_METRICS, {
    ...
    }, inputData, metrics_module.loadMetricsSuccessCallback, metrics_module.loadMetricsFailureCallback);
};
...
metrics_module.loadWccMetricsData = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_WCCMETRICS, {
        "Content-Type": "application/json",
        "Authorization": userInfo.headerAccessToken,
        "facilityId": userInfo.presentFacilityId,
        "userId": userInfo.userId,
        ...
        "deviceType": userInfo.deviceType,
        "deviceId": userInfo.sessionId
    }, inputData, metrics_module.loadWccMetricsSuccessCallback, metrics_module.loadMetricsFailureCallback);
...
metrics_module.loadUserMetricsData = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_USERMETRICS, {
        "Content-Type": "application/json",
        "Authorization": userInfo.headerAccessToken,
        "facilityId": userInfo.presentFacilityId,
        "userId": userInfo.userId,
        ...
        "deviceType": userInfo.deviceType,
        "deviceId": userInfo.sessionId
    }, inputData, metrics_module.loadUserMetricsSuccessCallback, metrics_module.loadMetricsFailureCallback);
};
//Success callback for wccmetrics service
...
var frmWCCDashboard_getPQCRData = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_MOREMETRICS, {
        "Content-Type": "application/json",
        "Authorization": userInfo.headerAccessToken,
        "facilityId": userInfo.presentFacilityId,
        "userId": userInfo.userId,
        ...
        "deviceType": userInfo.deviceType,
        "deviceId": userInfo.sessionId
    }, inputData, metrics_module.getPQCRDataSuccessCallback, metrics_module.getPQCRDataFailureCallback);
    //}
};
