...
function frmPatientSummary_SetCalendarContext(eventobject) {
    ...
    if (!isIpad) {
        ...
        var context = {
            "widget": frmPatientSummary.fcresulthdr,
            "anchor": "bottom"
        };
...
function frmPatientSummary_btnSaveClick(param) {
    ...
    if (isIpad && !isNetworkAvailable()) {
        ...
        //     }
        // else{
        com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_SAVEHEALSTEPS, {
        ...
        }, inputData, healing9StepDataModule.saveHealStepsSuccessCallback, healing9StepDataModule.saveHealStepsFailureCallback, patientSummaryObjects.showLoadingIndicatorFlag);
        //}
...
healing9StepDataModule.reviewMSR = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_MSRREVIEW, {
        "Content-Type": "application/json",
        "Authorization": userInfo.headerAccessToken,
        "patientId": patientSummaryObjects.patientDemoGraphics.patientId,
        "facilityId": userInfo.presentFacilityId,
        ...
        "deviceType": userInfo.deviceType,
        "deviceId": userInfo.sessionId
    }, inputData, healing9StepDataModule.reviewMSRSuccessCallBack, healing9StepDataModule.reviewMSRFailureCallBack);
};
...
healing9StepDataModule.mostRecentPhysicianOrders = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_MOSTRECENTPHYSICIANORDERS, //MF_SERVICECONSTANTS.OPERATION_NAME_MOSTRECENTPHYSICIANORDERS,
        {
            "Content-Type": "application/json",
            "Authorization": userInfo.headerAccessToken,
            "patientId": patientSummaryObjects.patientDemoGraphics.patientId,
            ...
            "deviceType": userInfo.deviceType,
            "deviceId": userInfo.sessionId
        }, inputData, healing9StepDataModule.mostRecentPhysicianOrdersSuccessCallBack, healing9StepDataModule.mostRecentPhysicianOrdersFailureCallBack);
};
...
function sync_9HealingStepSuccessCallback() {
    ...
    try {
        ...
        healingSubSteps_cntrl_offline.mapSubStepDetailsByPatientIdAndWoundNoAndStepNo(patientSummaryObjects.patientDemoGraphics.patientId, woundNumber, patientSummaryObjects.selectedStep);
