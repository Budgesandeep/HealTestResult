...
facilityListModule.getFilteredFacilityList = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_ADMINFACILITYLIST, {
    ...
    }, inputData, facilityListModule.facilityListSuccessCallback, facilityListModule.facilityListFailureCallback);
};
...
facilityListModule.facilityListSuccessCallback = function(response) {
        ...
        facilityList.sort(sort_by("name", false, function(a) {
                ...
                if (objFacilityScreens === "" || objFacilityScreens === undefined || objFacilityScreens.length === undefined || objFacilityScreens.length === 0) {
                    ...
                    for (var j = 0; j < objFacilityScreens.length; j++) {
                        ...
                        if (screenId === "1") {
                            ...
                            tempRecord["btncheckbox2"] = (enableFlag === "true" || enableFlag === true) ? {
                                skin: "sknbtncheck",
                                hoverSkin: "skbtntranshover"
                            } : {
                                skin: "sknbtnuncheck",
                            ...
                            tempRecord["btncheckbox1"] = (enableFlag === "true" || enableFlag === true) ? {
                                skin: "sknbtncheck",
                                hoverSkin: "skbtntranshover"
                            } : {
                                skin: "sknbtnuncheck",
...
var frmAdmin_onClearSearchFilter = function() {
    frmAdmin.segfacilitylist.removeAll();
    frmAdmin_alphabetsskin();
    FACILITY_LIST_SERVICE_DATA.sort(sort_by("lblfacilityname", false, function(a) {
        return a.toUpperCase()
    }))
    for (var j in FACILITY_LIST_SERVICE_DATA) {
