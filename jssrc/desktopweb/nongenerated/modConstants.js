...
var userApps = {
    totalApps: 11,
    landingIcons: ["btnwccdashboard", "btnpatientsafety", "btnadministration", "btnSystemNotification", "btnbilling", "btnsystemnotification", "btnregistration", "btncommunity", "btnscheduling", "btnprocedures", "btndme", "btnspotfire"],
    submenuIcons: ["btsmwcc", "btsmpatientsafety", "btsmadministration", "btsmhbo", "btsmbilling", "btnregistration", "btnsmcommunity", "btnscheduling", "btnprocedures", "btndme", "btnspotfire"]
};
...
var patientSummaryObjects = {
    ...
    arrwoundListColors:  ["sknlblbluebold80", "sknlblorangebold80", "sknlblyellowbold80", "sknlblvoiletbold80", "sknlblgreenbold80", "sknlblredbold80", "sknlblbluegreenbold80", "sknlblredorangebold80", "sknlblbluevioletbold80", "sknlblyelloworangebold80", "sknlblredvioletbold80", "sknlblyellowgreenbold80"],
    clear: function() {
...
var metrics_info = {
    ...
    info_description: ["Shows the number of patients who have their first made encounter within the date range of the report. Excludes all consult patients. In order to count as a new patient, there must be more than 30 calendar days since the patient’s previous discharge date.", "Identified by made encounter with any appointment type other than ‘HBO’. Only one encounter per calendar day/patient can be counted. The count excludes any non-billed encounters.", "Patient Satisfaction averages each satisfaction score for all sections of the patient satisfaction survey submitted electronically through Press Ganey within the selected analysis period.", "The mathematical median of days from first visit to last visit for each wound with an outcome of “Healed-Epithelialized,” “Healed-Surgical Closure,” “Healed-Flap,” or “Healed-Graft.”All results for the timeframe in question are placed in ascending order and the median result is selected.", "Reported as a rate. The rate is calculated using the denominator of all patients with an Active status at the time the report is run. The numerator is any patient with a wound in treatment for 14 or more weeks. Excluded from this calculation are any patients designated as palliative or complex wound care.", "Reported as a rate. The rate is calculated using the denominator of all wounds with an outcome, the numerator is all wounds with an outcome of either “Healed-Epithelialized” “Healed-Surgical Closure,” “Healed-Flap,” or “Healed-Graft.”", "Calculated by dividing the total number of wounds healed by the total number of wounds given an outcome during the timeframe noted. This does not include expired patients, those in palliative care or consultations. CHR includes complex patients. This is a different metric and should not be compared to any existing i-Heal or clinical reports. While challenging to heal, the inclusion of complex patients provides a more comprehensive and accurate representation of true patient outcomes.", "The outcomes assigned to patients that have been discharged from the center over the previous 3 months. Category options include healed and not healed.\nNeutral outcomes are included in the ‘not healed’ category.\nA ‘neutral’ outcome is defined as:\n1.Anticipated amputation upon presentation to the Wound Care Center\n2.Wounds treated outside the Wound Care Center (by another provider)\n3.Converted wounds (smaller wounds that have anatomically coalesced into a single, larger wound", "Calculated by dividing the total number of debridements by the total number of wounds assessed. This is further divided into Selective and Excisional categories."],
...
var recordListConstants = {
    ...
    records: [
        ...
        ["radScans", "Rad Scans"],
        ["photos", "Photos"],
        ["msrReviewDocs", "MSR Review Docs"],
        ["physicianOrders", "Physician Orders"],
        ["consents", "Consents"],
        ["faceSheets", "Face Sheets"],
        ["other", "Other"]
    ]
};
