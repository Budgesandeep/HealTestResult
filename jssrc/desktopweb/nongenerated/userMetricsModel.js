...
com.healogics.offline.userMetrics.prototype.getPKTable = function() {
    ...
    pkTable.metricsmonth = {
        key: "metricsmonth",
        value: this.metricsmonth
    };
    pkTable.metricsyear = {
        key: "metricsyear",
        value: this.metricsyear
    };
    pkTable.userId = {
        key: "userId",
        value: this.userId
