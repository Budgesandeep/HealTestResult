...
var woundSummaryGraphData = {
    ...
    colors: ['#0a8dff', '#ff6200', '#ffc902', '#7400ff', '#0a9f01', '#bf4040', '#00ffcf', '#ff2000', '#4a00ff', '#ffd200', '#a500ff', '#87ff00', '#0a8dff', '#ff6200', '#ffc902', '#7400ff', '#0a9f01', '#bf4040', '#00ffcf', '#ff2000', '#4a00ff', '#ffd200', '#a500ff', '#87ff00', '#0a8dff', '#ff6200', '#ffc902', '#7400ff', '#0a9f01', '#bf4040', '#00ffcf', '#ff2000', '#4a00ff', '#ffd200', '#a500ff', '#87ff00', '#0a8dff', '#ff6200', '#ffc902', '#7400ff', '#0a9f01', '#bf4040', '#00ffcf', '#ff2000', '#4a00ff', '#ffd200', '#a500ff', '#87ff00', '#0a8dff', '#ff6200', '#ffc902', '#7400ff', '#0a9f01', '#bf4040', '#00ffcf', '#ff2000', '#4a00ff', '#ffd200', '#a500ff', '#87ff00'],
    woundData: [],
    chartRangeDays: 0,
    xMin: 0,
    xMax: 0,
...
function formatWoundSummaryGraphDataForIPad() {
    ...
    woundSummaryGraphData.woundData.forEach(function(d, i) {
        ...
        dateArr.push(moment(Math.min.apply(Math, d.woundSummaryList.map(function(o) {
            if (o.x != null && !isNaN(o.x)) return o.x;
        }))));
...
*/
    ...
    xAxis = d3.svg.axis().scale(xScale).ticks(d3.time.daysTotal, xAxisTickSize).tickFormat(d3.time.format("%m/%d/%y")).orient("bottom").innerTickSize(-(svgConfig.height - svgConfig.padding));
