...
com.healogics.patientSummary = (function() {
    ...
    var _getPatientSummary = function(patientId, patientFirstName, patientLastName, showStepOne) {
        ...
        com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.ORCHESTRATION_SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_PATIENTSUMMARY, {
        ...
        }, inputData, _patientSummarySuccessCallback, _patientSummaryFailureCallback, patientSummaryObjects.showLoadingIndicatorFlag);
    };
    ...
    var _setSegWoundListData = function() {
        ...
        for (var i = 0; i < woundCount; i++) {
            ...
            var tempRow = {
                "lblwound": {
                    "text": "Wound " + patientSummaryObjects.woundDescriptionDetails[i].woundno + lmsrLabel
                }
            };
...
var frmPatientSummary_setWound9PointSegmentData = function(woundFeatures) {
    ...
    for (var i = 0; i < woundFeatures.length; i++) {
        var tempRow = {
            "lblfeaturetype": {
                "text": woundFeatures[i]
            },
            "template": fcfeaturetype
        };
        if (i === 0) {
            tempRow.imgfeaturetype = {
                "src": "onelinearrow.png",
                "width": "100%"
            };
        } else {
            tempRow.imgfeaturetype = {
...
var frmPatientSummary_handleMSRStatus = function() {
    ...
    if (strMsrFlag === "Y" || strMsrFlag === true || strMsrFlag == "true") {
        ...
        if (userInfo.acknowledgeMSR == GENERAL_CONSTANTS.TEXT_TRUE && woundMsrStatus != null && woundMsrStatus != "" && (
                (clinicianReviewFlag != null && (clinicianReviewFlag == "false" || clinicianReviewFlag == false) && userPatientRole.toLowerCase() == "clinician") || (physicianReviewFlag != null && (physicianReviewFlag == "false" || physicianReviewFlag == false) && userPatientRole.toLowerCase() == "physician"))) {
            ...
            if (userInfo.acknowledgeMSR == GENERAL_CONSTANTS.TEXT_TRUE && woundMsrStatus != null && woundMsrStatus != "" && (
                    (clinicianReviewFlag != null && (clinicianReviewFlag == true && physicianReviewFlag == false) && userPatientRole.toLowerCase() == "clinician") || (physicianReviewFlag != null && (physicianReviewFlag == true && clinicianReviewFlag == false) && userPatientRole.toLowerCase() == "physician"))) {
                frmPatientSummary.btnReviewMSR.setVisibility(true);
                frmPatientSummary.btnReviewMSR.text = "Review MSR";
        ...
        if (selectedWoundIndex != null) {
            ...
            if (woundMsrStatus != null && woundMsrStatus != "") {
                ...
                if (userInfo.acknowledgeMSR == GENERAL_CONSTANTS.TEXT_TRUE && woundMsrStatus != null && woundMsrStatus != "" && (
                    ...
                    //         )
                    if (
                        (clinicianReviewFlag != null && physicianReviewFlag != null && clinicianReviewFlag == true && physicianReviewFlag == false) || (clinicianReviewFlag != null && physicianReviewFlag != null && physicianReviewFlag == true && clinicianReviewFlag == false)) {
...
woundImagesModule.frmPatientSummary_getWoundImages = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_PHOTOMOBILE, {
        "Content-Type": "application/json",
        "Authorization": userInfo.headerAccessToken,
        ...
        "deviceType": userInfo.deviceType,
        "deviceId": userInfo.sessionId
    }, inputData, woundImagesModule.getWoundImagesSuccessCallback, woundImagesModule.getWoundImagesFailureCallback);
};
        ...
        if (woundImageConstants.imageListLength > 0) {
            ...
            for (i = 0; i < woundImageConstants.imageListLength; i++) {
                wound_data = {
                    ...
                    "imgwound": {
                        base64: woundImageConstants.woundImagesList[i].docBase64
                    }
...
woundImagesModule.frmPatientSummary_getNextWoundImage = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_GETWOUNDIMAGE, {
        "Content-Type": "application/json",
        "Authorization": userInfo.headerAccessToken,
        "facilityId": userInfo.presentFacilityId,
        "userId": userInfo.userId,
        ...
        "deviceType": userInfo.deviceType,
        "deviceId": userInfo.sessionId
    }, inputData, woundImagesModule.getWoundImageDownloadSuccessCallback, woundImagesModule.getWoundImageDownloadFailureCallback, false);
};
