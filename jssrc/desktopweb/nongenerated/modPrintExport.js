...
printExportModule.generatePdf = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_CPGLINK, MF_SERVICECONSTANTS.OPERATION_NAME_GENERATEPDF, {
        "Content-Type": "application/json",
        "Authorization": userInfo.headerAccessToken
    }, inputData, printExportModule.generatePdfSuccessCallback, printExportModule.generatePdfFailureCallback);
};
printExportModule.generatePdfSuccessCallback = function(response) {
    ...
    if (isIpad) {
        ...
        if (PRINT_EXPORT_TEMPLATES.PRINT_ACTION === "Print") onclickViewPdf();
        else {
...
printExportModule.generateExcel = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_CPGLINK, MF_SERVICECONSTANTS.OPERATION_NAME_GENERATEPDF, {
        "Content-Type": "application/json",
        "Authorization": userInfo.headerAccessToken
    }, inputData, printExportModule.generateExcelSuccessCallback, printExportModule.generatePdfFailureCallback);
};
