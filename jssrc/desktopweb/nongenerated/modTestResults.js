...
getTestResultsList = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_TESTRESULTS, MF_SERVICECONSTANTS.OPERATION_NAME_GETTESTRESULTSLIST, {}, inputData, getTestResultsListSuccesscall, getTestResultsListFailurecall);
};
            ...
            if (res.results[i].groupName == "Consults" && lblTestType == "Consults") {
                ...
                var tempConsults = {
                    "btnTestResultDescription": {
                        "text": res.results[i].testDescription
                    },
                    "lblTestResultDateOrdered": {
                        "text": res.results[i].orderDate
                    },
                    "lblTestResultsDateCompleted": {
                        "text": lblTestResultsDateCompleted
                    },
                    "btnTestResultAttachment": {
                        "text": "View Document"
                    },
                    "txtRichTestResult": {
                        "text": lblTestResultResults
                    },
                    "btnOnHoverResult": {
                        "text": ""
                    },
                    "lblTestResultResults": {
                        "text": res.results[i].resultsObservation
                    },
                };
