...
function frmPatientRecords_postShowfunc() {
    ...
    hideFormMenu();
    load_headerdata();
    if (isIpad) changeConnectionStatus(isNetworkAvailable());
    ...
    if (isIpad) frmPatientRecords.btnConnected.setEnabled(false);
...
recordsModule.prepareRecordTypesSegment = function() {
    ...
    if (len > 0) {
        if (isIphone) {
            ...
            tempRecord[uploadDocumentConstants.selectedRow].imgBackground = {
...
recordsModule.getRecords = function(successCallback, failureCallback) {
    ...
    if (isIpad && !isNetworkAvailable()) {
        ...
        com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_GETDOCUMENTTYPES, {
        ...
        }, inputData, function(response) { //Success callback
...
var frmPatientRecords_getDocumentList = function() {
    ...
    if (isIpad && !isNetworkAvailable()) {
        ...
        com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_GETDOCUMENTLIST, {
            "Content-Type": "application/json",
            "Authorization": userInfo.headerAccessToken,
            "patientId": patientSummaryObjects.patientDemoGraphics.patientId,
            "facilityId": userInfo.presentFacilityId,
            ...
            "deviceType": userInfo.deviceType,
            "deviceId": userInfo.sessionId
        }, inputData, recordsModule.getDocumentsSuccessCallback, recordsModule.getDocumentListFailureCallback);
    }
};
...
recordsModule.getDocList = function(response) {
    ...
    if (com.healogics.utility.isEmpty(recordListConstants.documentList) || len === 0) {
        ...
        for (i = 0; i < len; i++) {
            var tempRecord = {
                "btnDocument": {
                    text: recordListConstants.documentList[i].documentName
                }, //".pdf"
                "btnDelete": {
                    skin: "skbtnDelete",
                    isVisible: true
...
var frmPatientRecords_deleteDocument = function(context) {
    ...
    if (isIpad && !isNetworkAvailable()) {
        ...
        com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_DELETEDOCUMENT, {
            "Content-Type": "application/json",
            "Authorization": userInfo.headerAccessToken,
            "facilityId": userInfo.presentFacilityId,
            "userId": userInfo.userId,
            ...
            "deviceType": userInfo.deviceType,
            "deviceId": userInfo.sessionId
        }, inputData, recordsModule.deleteDocumentSuccessCallback, recordsModule.RecordsModuleFailureCallback);
    }
};
...
recordsModule.setListData = function() {
    ...
    if (isIphone) frmPatientDetails.listboxDocType.masterData = docTypeArray;
    else frmPatientRecords.listboxDocType.masterData = docTypeArray;
};
...
var frmPatientRecords_showDocument = function(context) {
    ...
    if (isIpad && !isNetworkAvailable()) {
        ...
        com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_VIEWDOCUMENT, {
            "Content-Type": "application/json",
            "Authorization": userInfo.headerAccessToken,
            "facilityId": userInfo.presentFacilityId,
            "userId": userInfo.userId,
            ...
            "deviceType": userInfo.deviceType,
            "deviceId": userInfo.sessionId
        }, inputData, recordsModule.showDocumentSuccessCallback, recordsModule.RecordsModuleFailureCallback);
    }
};
