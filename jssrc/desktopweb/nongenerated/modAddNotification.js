...
addNotificationModule.saveNotification = function() {
    ...
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, operationName, {
    ...
    }, inputData, addNotificationModule.addNotificationSuccessCallback, addNotificationModule.addNotificationErrorCallback, true);
};
...
addNotificationModule.validateDate = function() {
    var result = {
        "status": true,
        "error_msg": ERROR_CONSTANTS.NOTIFICATION_DATE_ERROR_MESSAGE
    };
    var index = 0;
...
addNotificationModule.fetchFacilityList = function() {
    var inputData = {};
    com.healogics.mfutility.invokeIntegrationService(MF_SERVICECONSTANTS.SERVICE_NAME_ACTUAL, MF_SERVICECONSTANTS.OPERATION_NAME_NOTIFICATION_FACILITYLIST, {
        "Authorization": userInfo.headerAccessToken,
        "facilityId": userInfo.presentFacilityId,
        "userId": userInfo.userId,
        "userName": userInfo.userName,
        "deviceType": userInfo.deviceType,
        "deviceId": userInfo.sessionId
    }, inputData, addNotificationModule.facilityListSuccessCallback, addNotificationModule.facilityListFailureCallback, false);
};
...
addNotificationModule.setFacilityData = function(facilityList) {
    ...
    for (var i in facilityList) {
        ...
        var segObject = {
            lblBlueBookCode: facilityObj.bluebook_code,
            btnSelection: {
                "skin": "sknbtnuncheck"
            },
            "lblFacilityID": facilityObj.facility_id
        };
        var segObjectForSelectAll = {
            lblBlueBookCode: facilityObj.bluebook_code,
            btnSelection: {
                "skin": "sknbtncheck"
            },
        ...
        addNotificationModule.facilityHashMap[facilityObj.bluebook_code] = {
            "facility_id": facilityObj.facility_id,
            "bluebook_code": facilityObj.bluebook_code
        };
    ...
    if (!com.healogics.utility.isEmpty(prevSelectedFacilities) && prevSelectedFacilities.length > 0) {
        for (var count in prevSelectedFacilities) {
            ...
            if (index !== -1) {
                ...
                addNotificationModule.selectedFacilities[facility.bluebook_code] = {
                    "facility_id": facility.facility_id,
                    "bluebook_code": facility.bluebook_code
                };
            }
        }
    }
...
frmNotificationDashboard_segFacilityButtonHandler = function(selectedButtonObj, SegContext) {
    ...
    if (selectedButtonObj.skin === "sknbtnuncheck") {
        ...
        addNotificationModule.selectedFacilities[selectedFacility.lblBlueBookCode] = {
            "facility_id": selectedFacility.lblFacilityID,
            "bluebook_code": selectedFacility.lblBlueBookCode
        };
